...
from app.agents.sub_agents.data_analysis import (
...
class DataAnalysisTaskAgent:
    def __init__(self):
        self.planner = DataAnalysisPlannerSubAgent()
        self.writer = DataAnalysisWriterSubAgent()
        self.reviewer = DataAnalysisReviewerSubAgent()
