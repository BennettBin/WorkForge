...
## Workflow
1. Read uploaded Excel (`xlsx/xls`) and locate configured target column (default `cate`).
...
- If target column is missing, raise explicit error for upstream fallback handling.
